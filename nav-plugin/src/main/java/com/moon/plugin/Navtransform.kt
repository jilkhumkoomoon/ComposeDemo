...
class NavTransform(private val project: Project) : Transform(){
    ...
    companion object {
        const val NAV_RUNTIME_DESTINATION = "Lcom/moon/plugin/runtime/NavDestination;"
        const val NAV_RUNTIME_NAV_TYPE = "Lcom/moon/plugin/runtime/NavDestination\$NavType"

        private const val KEY_ROUTE = "route"
        private const val KEY_TYPE = "type"
        private const val KEY_STARTER = "asStarter"

        private const val NAV_RUNTIME_PKG_NAME: String = "com.moon.plugin.runtime"
